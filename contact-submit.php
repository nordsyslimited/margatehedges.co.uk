...
$BASE = 'https://margatehedges.co.uk';
...
$subject = 'New hedge enquiry, margatehedges.co.uk';
...
<!doctype html>
<html>
<body style="margin:0;padding:24px;background:#faf5ea;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;color:#1a2a35;">
  <div style="max-width:640px;margin:0 auto;background:#fff;border:1px solid #d8ccb4;border-radius:12px;padding:28px;">
    <div style="font-size:11px;text-transform:uppercase;color:#4c5b66;letter-spacing:0.05em;margin-bottom:6px;">New enquiry</div>
    <h1 style="margin:0 0 16px;font-size:22px;color:#1a2a35;">Hedge enquiry from {$escName}</h1>
    <table style="width:100%;border-collapse:collapse;font-size:15px;">
      <tr><td style="padding:8px 0;border-bottom:1px solid #eee;width:140px;color:#4c5b66;">Name</td><td style="padding:8px 0;border-bottom:1px solid #eee;">{$escName}</td></tr>
      <tr><td style="padding:8px 0;border-bottom:1px solid #eee;color:#4c5b66;">Address</td><td style="padding:8px 0;border-bottom:1px solid #eee;">{$escAddress}</td></tr>
      <tr><td style="padding:8px 0;border-bottom:1px solid #eee;color:#4c5b66;">Postcode</td><td style="padding:8px 0;border-bottom:1px solid #eee;">{$escPostcode}</td></tr>
      <tr><td style="padding:8px 0;border-bottom:1px solid #eee;color:#4c5b66;">Location</td><td style="padding:8px 0;border-bottom:1px solid #eee;">{$escLocation}</td></tr>
      <tr><td style="padding:8px 0;border-bottom:1px solid #eee;color:#4c5b66;">Phone</td><td style="padding:8px 0;border-bottom:1px solid #eee;"><a href="tel:{$escPhone}" style="color:#366668;">{$escPhone}</a></td></tr>
      <tr><td style="padding:8px 0;border-bottom:1px solid #eee;color:#4c5b66;">Email</td><td style="padding:8px 0;border-bottom:1px solid #eee;"><a href="mailto:{$escEmail}" style="color:#366668;">{$escEmail}</a></td></tr>
      <tr><td style="padding:8px 0;border-bottom:1px solid #eee;color:#4c5b66;">Has WhatsApp?</td><td style="padding:8px 0;border-bottom:1px solid #eee;font-weight:600;">{$escWA}</td></tr>
      <tr><td style="padding:8px 0;border-bottom:1px solid #eee;color:#4c5b66;">Submitted</td><td style="padding:8px 0;border-bottom:1px solid #eee;">{$escTime}</td></tr>
    </table>
    <h2 style="margin:22px 0 8px;font-size:15px;color:#4c5b66;text-transform:uppercase;letter-spacing:0.04em;">Job details</h2>
    <div style="line-height:1.6;background:#f0e6d2;border-radius:8px;padding:14px 16px;">{$escMsg}</div>
...
$plain = "New hedge enquiry, margatehedges.co.uk\n\n"
       . "Name:     {$name}\n"
       . "Address:  {$address}\n"
       . "Postcode: {$postcode}\n"
       . "Location: {$location}\n"
